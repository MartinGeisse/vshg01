...
public class PicoBlazeDocumentPartitioner extends FastPartitioner {
	...
	/**
	 * the TOKEN_TYPE_MULTI_LINE_COMMENT
	 */
	public static final String TOKEN_TYPE_MULTI_LINE_COMMENT = "MULTI_LINE_COMMENT";
	...
	private static class MyPartitionScanner extends RuleBasedPartitionScanner {
		...
		public MyPartitionScanner() {
			IPredicateRule[] rules = new IPredicateRule[] {
				new MultiLineRule("/*", "*/", new Token(TOKEN_TYPE_MULTI_LINE_COMMENT), (char)0, true),
