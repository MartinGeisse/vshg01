...
import name.martingeisse.ecotools.simulator.cpu.usermode.ClearMemoryAction;
import name.martingeisse.ecotools.simulator.cpu.usermode.ReadFromStreamAction;
import name.martingeisse.ecotools.simulator.cpu.usermode.ReadStringAction;
import name.martingeisse.ecotools.simulator.cpu.usermode.SparseMemory;
import name.martingeisse.ecotools.simulator.cpu.usermode.UsermodeCpu;
import name.martingeisse.ecotools.simulator.cpu.usermode.unix.FilePointerTable;
