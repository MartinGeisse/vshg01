...
void *malloc(size_t size) {
  ...
  // number of units to allocate including the allocation header --
  // each Header contains the size (in units) of the storage for
  // that header *including the header* !
